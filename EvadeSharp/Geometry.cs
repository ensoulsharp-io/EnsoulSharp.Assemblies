    ...
    public static class Geometry
    {
        ...
        public class Arc
        {
            ...
            public Polygon ToPolygon(int offset = 0)
            {
                ...
                var innerCenters = Extensions.CircleCircleIntersection(Start, End, innerRadius, innerRadius);
                var outerCenters = Extensions.CircleCircleIntersection(Start, End, outerRadius, outerRadius);
