...
namespace OneKeyToWin_AIO_Sebby.Champions
{
    class Jinx : Program
    {
        ...
        public Jinx()
        {
            ...
            W.SetSkillshot(0.6f, 60, 3300, true, SkillshotType.Line);
            E.SetSkillshot(1f, 60, 1750, false, SkillshotType.Circle);
            R.SetSkillshot(0.6f, 140, 1700, false, SkillshotType.Line);
