...
namespace OneKeyToWin_AIO_Sebby.Core
{
    class OKTWdash
    {
        ...
        public OKTWdash(Spell qwer)
        {
            ...
            menu.Add(new MenuList<string>("DashMode", "Dash MODE", new[] { "Game Cursor", "Side", "Safe position" }, Player.CharacterName) { Index = 2 });
            ...
            gap.Add(new MenuList<string>("GapcloserMode", "Gapcloser MODE", new[] { "Game Cursor", "Away - safe position", "Disable" }, Player.CharacterName) { Index = 1 });
        ...
        private void Gapcloser_OnGapcloser(AIHeroClient sender, Gapcloser.GapcloserArgs args)
        {
            ...
            {
                var gapcloserMode = menu["gap"].GetValue<MenuList<string>>("GapcloserMode").Index;
                if (gapcloserMode == 0)
                {
